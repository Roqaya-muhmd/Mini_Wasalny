...
public:
    ...
    QLabel *label;
    QLabel *label_waring2;
    QLineEdit *lineEdit;
    QLabel *label_2;
    QLabel *label_waring3;
    QLineEdit *lineEdit_2;
    QLabel *label_3;
    QLabel *label_waring4;
    ...
    void setupUi(QWidget *addgraph)
    {
        ...
        addgraph->resize(468, 474);
        addgraph->setStyleSheet(QString::fromUtf8(""));
        ...
        label_4->setMinimumSize(QSize(120, 50));
        label_4->setMaximumSize(QSize(120, 50));
        QFont font;
        font.setPointSize(15);
        label_4->setFont(font);
        label_4->setStyleSheet(QString::fromUtf8("QQLabel {\n"
...
"}"));
        ...
        label_warning = new QLabel(addgraph);
        label_warning->setObjectName("label_warning");
        label_warning->setMinimumSize(QSize(120, 20));
        label_warning->setMaximumSize(QSize(120, 20));
        QFont font1;
        ...
        verticalLayout->addWidget(label_warning, 0, Qt::AlignmentFlag::AlignHCenter);
...
"}"));
        ...
        pushButton_2 = new QPushButton(addgraph);
...
"	}"));
        ...
        pushButton_2->setIconSize(QSize(11, 11));
        ...
        label->setFont(font);
        label->setStyleSheet(QString::fromUtf8("QQLabel {\n"
"    qproperty-alignment: AlignCenter; /* \330\252\331\210\330\263\331\212\330\267 \330\247\331\204\331\206\330\265 (\330\250\330\257\331\210\331\206 CSS \330\271\330\247\330\257\331\212!) */\n"
"    background: qlineargradient(x1:0, y1:0, x2:1, y2:1,\n"
"                               stop:0 #3498db, stop:1 #2ecc71); /* \330\254\330\261\330\247\330\257\331\212\331\206\330\252 */\n"
"    border: 2px solid #2980b9;\n"
...
"}"));
        ...
        label_waring2 = new QLabel(addgraph);
        label_waring2->setObjectName("label_waring2");
        label_waring2->setMinimumSize(QSize(120, 20));
        label_waring2->setMaximumSize(QSize(120, 20));

        verticalLayout->addWidget(label_waring2, 0, Qt::AlignmentFlag::AlignHCenter);
...
"}"));
        ...
        label_2->setStyleSheet(QString::fromUtf8("QQLabel {\n"
"    qproperty-alignment: AlignCenter; /* \330\252\331\210\330\263\331\212\330\267 \330\247\331\204\331\206\330\265 (\330\250\330\257\331\210\331\206 CSS \330\271\330\247\330\257\331\212!) */\n"
"    background: qlineargradient(x1:0, y1:0, x2:1, y2:1,\n"
"                               stop:0 #3498db, stop:1 #2ecc71); /* \330\254\330\261\330\247\330\257\331\212\331\206\330\252 */\n"
"    border: 2px solid #2980b9;\n"
...
"}"));
        ...
        label_waring3 = new QLabel(addgraph);
        label_waring3->setObjectName("label_waring3");
        label_waring3->setMinimumSize(QSize(120, 20));
        label_waring3->setMaximumSize(QSize(120, 20));

        verticalLayout->addWidget(label_waring3, 0, Qt::AlignmentFlag::AlignHCenter);
        ...
        label_3->setStyleSheet(QString::fromUtf8("QQLabel {\n"
"    qproperty-alignment: AlignCenter; /* \330\252\331\210\330\263\331\212\330\267 \330\247\331\204\331\206\330\265 (\330\250\330\257\331\210\331\206 CSS \330\271\330\247\330\257\331\212!) */\n"
"    background: qlineargradient(x1:0, y1:0, x2:1, y2:1,\n"
"                               stop:0 #3498db, stop:1 #2ecc71); /* \330\254\330\261\330\247\330\257\331\212\331\206\330\252 */\n"
"    border: 2px solid #2980b9;\n"
...
"}"));
        ...
        label_waring4 = new QLabel(addgraph);
        label_waring4->setObjectName("label_waring4");
        label_waring4->setMinimumSize(QSize(120, 20));
        label_waring4->setMaximumSize(QSize(120, 20));

        verticalLayout->addWidget(label_waring4, 0, Qt::AlignmentFlag::AlignHCenter);
...
"	}"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/add-16.ico"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
